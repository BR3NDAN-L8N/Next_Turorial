 ...
 *
 * @param invoice - The invoice data to be edited.
 * @param customers - A list of customers to populate the customer selection dropdown.
 *
 * @returns A form for editing an invoice.
 */
